...
var spotDirectPosition = {type: 'v3', value: new THREE.Vector3(1.0,1.0,1.0)};
var ballPosition = {type: 'v3', value: new THREE.Vector3(0.0,0.0,0.0)};
var spanningUniform = {type: "f", value: spanning};
var jumpUniform = {type: 'f', value: jump};
// Materials
...
var toonMaterial = new THREE.ShaderMaterial({
    uniforms: {
        ...
        spanningUniform: spanningUniform,
    },
});

var toonMaterial2 = new THREE.ShaderMaterial({
    uniforms: {
        lightColorUniform: lightColorUniform,
        kAmbientUniform: kAmbientUniform,
        lightDirectionUniform: lightDirectionUniform,
...
var toonMaterial3 = new THREE.ShaderMaterial({
    uniforms: {
        lightColorUniform: lightColorUniform,
        kAmbientUniform: kAmbientUniform,
        lightDirectionUniform: lightDirectionUniform,
...
new THREE.SourceLoader().load(shaderFiles, function(shaders) {
  ...
  fogMaterial.fragmentShader = shaders['glsl/fog.fs.glsl'];
    ...
    toonMaterial2.fragmentShader = shaders['glsl/toon2.fs.glsl'];
    toonMaterial2.vertexShader = shaders['glsl/toon2.vs.glsl'];
    toonMaterial3.fragmentShader = shaders['glsl/toon3.fs.glsl'];
    toonMaterial3.vertexShader = shaders['glsl/toon3.vs.glsl'];
})
...
loadOBJ(Part.TOON, 'obj/cloud.obj', toonMaterial, 0.03, 0, 0, 0, 0,0,0);
loadOBJ(Part.TOON, 'obj/grass.obj', toonMaterial2, 0.03, 0, 0, 0, 0,0,0);
loadOBJ(Part.TOON, 'obj/LEGO_Man.obj', toonMaterial, 0.5, 0, 0, 0, 0,0,0);
loadOBJ(Part.TOON, 'obj/tree01.obj', toonMaterial, 1, 4, 0.3, 1, 0,0,0);
loadOBJ(Part.TOON, 'obj/tree02.obj', toonMaterial, 1, 6, 0.3, -1, 0,0,0);
loadOBJ(Part.TOON, 'obj/tree03.obj', toonMaterial, 1, 2, 0.3, -1, 0,0,0);
loadOBJ(Part.TOON, 'obj/cat.obj', toonMaterial3, 0.005, -2, 0.3, 1, 0,0,0);
// LISTEN TO KEYBOARD
...
function checkKeyboard() {
  ...
  toonMaterial3.needsUpdate = true;
...
function update() {
  ...
  if(mode == Part.TOON){
      if(spanning<1000){
          spanningUniform.value += 0.01;
          jumpUniform.value += 0.1; 
      }
